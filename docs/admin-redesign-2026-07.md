...
- Insert and delete input uses a block-style overlay caret, active-line pulse, and generated mechanical click. Keep visuals compositor-only, selection-safe, IME-safe, and governed by the global motion/reduced-motion settings; keep audio locally generated at the documented 30% internal volume and out of composition updates. The Rendering card switch controls the complete typewriter system and defaults on for existing installs.
