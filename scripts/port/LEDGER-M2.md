# Port ledger — M2, the public renderer

Closed 2026-07-27. Split out of [LEDGER.md](LEDGER.md), which carries the current
milestone. Write-only from here: this is the record of what M2 did, not a document that
gets revised.
