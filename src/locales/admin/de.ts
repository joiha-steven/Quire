...
const de = {
  ...
  typographyHint: 'Schriftgröße (rem) für Fließtext und jede Überschriftsebene, seitenweit. Titel verwenden H1.',
  typoBase: 'Fließtext',
  typoH1: 'H1 (Titel)',
  typoH2: 'H2',
  typoH3: 'H3',
  ...
  cardFont: 'Schriftart',
  fontHint: 'Eigene Schriftart hochladen (.woff2, .woff, .ttf, .otf). Wird bei den Dateien gespeichert und seitenweit angewendet.',
  fontDefault: 'Standard (Inter)',
  fontChoose: 'Schrift hochladen',
  cardRhythm: 'Abstände & Darstellung',
  rhythmHint: 'Zeilenabstand, Zeichenabstand und Kantenglättung für den Lesetext.',
