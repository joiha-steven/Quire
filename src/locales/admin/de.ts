...
const de = {
  ...
  cardTypography: 'Überschriftengrößen',
  typographyHint: 'Schriftgröße (rem) je Überschriftsebene, seitenweit angewendet. Titel verwenden H1. Fließtext ist 1.125rem.',
  typoH1: 'H1 (Titel)',
  typoH2: 'H2',
  typoH3: 'H3',
  typoH4: 'H4',
