...
const de = {
  ...
  commentsFacebookAuth: 'Mit Facebook anmelden',
  ...
  commentsKeyFbId: 'App-ID',
  commentsKeyFbSecret: 'App-Secret',
  ...
  commentsFacebookHelp: 'Meta for Developers → App erstellen → Facebook Login hinzufügen, dann App-ID + App-Secret verwenden. Redirect-URL /api/auth/callback/facebook eintragen.',
