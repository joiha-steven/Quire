...
const en = {
  ...
  typographyHint: 'Font size (rem) for body text and each heading level, applied site-wide. Titles use H1.',
  typoBase: 'Body text',
  typoH1: 'H1 (titles)',
  typoH2: 'H2',
  typoH3: 'H3',
  ...
  cardFont: 'Font',
  fontHint: 'Upload a custom typeface (.woff2, .woff, .ttf, .otf). It is stored with your files and applied site-wide.',
  fontDefault: 'Default (Inter)',
  fontChoose: 'Upload font',
  cardRhythm: 'Spacing & rendering',
  rhythmHint: 'Line spacing, letter spacing, and font smoothing for the reading text.',
