...
const en = {
  ...
  dashViews30: 'Views · 30 days',
  dashVisitors30: 'Visitors · 30 days',
  ...
  viewSite: 'View site',
  seoTitle: 'SEO health',
  seoNoExcerpt: 'No excerpt',
  seoNoImage: 'No cover image',
  seoAllGood: 'Every published post has an excerpt and a cover image.',
  sourcesTitle: 'Traffic sources (30 days)',
  sourcesReferrers: 'Top referrers',
  sourcesCountries: 'Top countries',
  sourcesDirect: 'Direct / none',
  sourcesEmpty: 'No traffic data yet.',
  sysBackupLast: 'Last backup',
  sysBackupNever: 'never',
  ...
  commentsAuthDesc: 'Turning this on lets outside readers sign in with this account to comment (no name/email, no Turnstile).',
  ...
  commentsGoogleHelp: 'Reuses your Google sign-in — no key needed here. To let OUTSIDE readers sign in, publish your OAuth consent screen to "Production" in Google Cloud Console (in "Testing" only you can sign in).',
  ...
  backupTitle: 'Backups',
  exportHint: 'Download everything as one archive: the database, the uploads and the settings. Restoring it replaces the current install.',
  exportNow: 'Download archive',
  exportBusy: 'Preparing…',
  exportReplicationNote: 'Continuous replication is handled outside this application (litestream), so there is nothing to connect here. This archive is the manual copy you can hold.',
  ...
  authTwoFactorHint: 'Open your authenticator app and enter the 6-digit code for Quire.',
