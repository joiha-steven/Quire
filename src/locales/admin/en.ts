...
const en = {
  ...
  commentsFacebookAuth: 'Sign in with Facebook',
  ...
  commentsFacebookHelp: 'Meta for Developers → Create app → add Facebook Login, then use the App ID + App secret. Add the redirect URL /api/auth/callback/facebook.',
