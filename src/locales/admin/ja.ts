...
const ja = {
  ...
  typographyHint: '本文と各見出しレベルのフォントサイズ（rem）。サイト全体に適用。タイトルはH1。',
  typoBase: '本文',
  typoH1: 'H1（タイトル）',
  typoH2: 'H2',
  typoH3: 'H3',
  ...
  cardFont: 'フォント',
  fontHint: 'カスタムフォントをアップロード（.woff2, .woff, .ttf, .otf）。ファイルと一緒に保存され、サイト全体に適用されます。',
  fontDefault: 'デフォルト（Inter）',
  fontChoose: 'フォントをアップロード',
  cardRhythm: '間隔と表示',
  rhythmHint: '本文の行間、字間、フォントの滑らかさ。',
  lineHeight: '行間',
  letterSpacing: '字間',
