...
const ko = {
  ...
  commentsFacebookAuth: 'Facebook으로 로그인',
  ...
  commentsFacebookHelp: 'Meta for Developers → 앱 생성 → Facebook 로그인 추가 후 App ID와 App secret을 사용하세요. 리디렉션 URL /api/auth/callback/facebook 을 추가하세요.',
