...
const ko = {
  ...
  typographyHint: '본문과 각 제목 단계의 글자 크기(rem). 사이트 전체에 적용됩니다. 제목은 H1을 사용합니다.',
  typoBase: '본문',
  typoH1: 'H1 (제목)',
  typoH2: 'H2',
  typoH3: 'H3',
  ...
  cardFont: '글꼴',
  fontHint: '사용자 글꼴 업로드(.woff2, .woff, .ttf, .otf). 파일과 함께 저장되어 사이트 전체에 적용됩니다.',
  fontDefault: '기본값 (Inter)',
  fontChoose: '글꼴 업로드',
  cardRhythm: '간격 및 표시',
  rhythmHint: '본문의 줄 간격, 자간, 글꼴 스무딩.',
  lineHeight: '줄 간격',
  letterSpacing: '자간',
