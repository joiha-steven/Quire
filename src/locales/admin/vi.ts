...
const vi = {
  ...
  commentsFacebookAuth: 'Đăng nhập Facebook',
  ...
  commentsFacebookHelp: 'Meta for Developers → Tạo app → thêm Facebook Login, rồi lấy App ID + App secret. Nhớ thêm redirect URL /api/auth/callback/facebook.',
