...
const vi = {
  ...
  tabAdvanced: 'Chuyên sâu',
  cardTypography: 'Kích thước chữ',
  typographyHint: 'Cỡ chữ (rem) cho chữ thường và từng cấp tiêu đề, áp dụng toàn trang. Tiêu đề bài dùng H1.',
  typoBase: 'Chữ thường',
  typoH1: 'H1 (tiêu đề)',
  typoH2: 'H2',
  typoH3: 'H3',
  ...
  cardFont: 'Phông chữ',
  fontHint: 'Tải lên phông chữ tùy chỉnh (.woff2, .woff, .ttf, .otf). File lưu cùng kho tệp và áp dụng toàn trang.',
  fontDefault: 'Mặc định (Inter)',
  fontChoose: 'Tải phông chữ',
  cardRhythm: 'Khoảng cách & hiển thị',
  rhythmHint: 'Khoảng cách dòng, khoảng cách chữ và khử răng cưa cho phần chữ đọc.',
