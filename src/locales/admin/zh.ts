...
const zh = {
  ...
  commentsFacebookAuth: '用 Facebook 登录',
  ...
  commentsFacebookHelp: 'Meta for Developers → 创建应用 → 添加 Facebook 登录，然后使用 App ID 与 App secret。请添加回调地址 /api/auth/callback/facebook。',
