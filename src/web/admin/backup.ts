...
//
// Quire 2.0 does NOT back up to Google Drive. Getting a copy off the box is an operational
// job, done by a cron script beside the process rather than by the application — parity
// exception 1, which deleted ~730 lines of OAuth, token refresh and Drive folder
// bookkeeping. See docs/backups.md. What that exception promised in exchange is this: an
// archive the owner can download and keep somewhere they control, without a third party in
// the path, and without shell access.
//
