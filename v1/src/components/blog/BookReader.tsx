...
// The book-mode overlay itself — the heavy part (pagination measurement, keyboard/arrow nav,
// the cloned-content flow). Loaded LAZILY by BookMode via next/dynamic, so this code and its
// CSS reach the browser only when a reader actually opens book mode — never on first paint,
// never on listings. It re-flows the current post into a two-column spread paginated
// horizontally with a soft fade; the base page keeps normal scroll (SEO / a11y untouched).
