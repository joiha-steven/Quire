...
| `sharp` / `satori` native and wasm parts do not embed in the compiled executable | Medium | Ship them beside the binary. The Go plan had the same asterisk via cgo and libvips |
