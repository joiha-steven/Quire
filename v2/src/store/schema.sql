...
--
-- Translated from the Postgres schema (`../../../scripts/schema.sql`, 612 lines) per
-- v2/docs/01-schema.md. Read that document before changing anything here; it records why
