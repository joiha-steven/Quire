...
/* The table of contents. Server-rendered markup, so these rules apply with or without
   JavaScript; only the aria-current highlight comes from the bundle. Set in the chrome font
   and kept quiet, because it must not compete with the article.
...
:root{--rail-w:250px;--rail-gap:40px;--rail-pad:14px;--rail-top:0px}
.rail{position:relative}
.rail-row{position:relative;display:flex}
.rail-row[aria-current]::before{content:"";position:absolute;top:.4em;bottom:.4em;left:0;
